...
class iCrypto {
    constructor(settings){
        ...
        this.rsa = {
            ...
            encrypt: this.publicKeyEncrypt,
            decrypt: this.privateKeyDecrypt,
            sign: this.privateKeySign,
            verify: this.publicKeyVerify,
            setKey: this.setRSAKey
        };

        this.aes = {
            createKey: this.createSYMKey,
            encrypt: this.AESEncrypt,
            decrypt: this.AESDecrypt
        }
    ...
    AESEncrypt(target = this.pRequired("AESEncrypt"),
               ...
               ivLength = 32){
        let self = this;
        let iv = forge.random.getBytesSync(ivLength);
