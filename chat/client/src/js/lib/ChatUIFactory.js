...
export function bakeHeaderLeftSection(uxBus){
...
export function bakeTopicAssets(topic, uxBus){
    ...
    for(let participant of topic.participants){
        let participantItem = bakeParticipantListItem({
            ...
            participantPkfp: participant.pkfp,
    ...
    for(let invite of topic.invites){
        let inviteItem = bakeInviteListItem(uxBus, topic.pkfp, invite.getCode(), invite.getAlias())
