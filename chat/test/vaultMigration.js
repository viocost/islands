...
describe("History export", ()=>{
    ...
    it('Should export the history', async ()=>{
        let historyPath = "/home/kostia/sandbox/islands/data/IslandsChat/history"
        let vaultsPath = "/home/kostia/sandbox/islands/data/IslandsChat/vaults"
    ...
    it('Should import the vault', async ()=>{
        ...
        await importVault(pathToZip, pathToHistory, true, "123qweasd");
        assert(1===1);
    }).timeout(20000)
