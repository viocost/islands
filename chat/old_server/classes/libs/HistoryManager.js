...
class HistoryManager{
    ...
    pathToHistory(pkfp = Err.required("Path to history")){
        return path.join(this.getHistoryDirectory(pkfp) , pkfp , "history_store");
    }
    ...
    pathToHSPrivateKey(pkfp = Err.required("Path to history")){
        return path.join(this.getHistoryDirectory(pkfp) , pkfp , "owner_hs_private_key");
    }


    pathToAttachments(pkfp = Err.required(('pathToAttachments'))){
        return path.join(this.getHistoryDirectory(pkfp) , pkfp , "files");
    }
    ...
    getPath(pkfp = Err.required('getPath: pkfp'),
        ...
        return path.join(this.getHistoryDirectory(pkfp) , pkfp , this.commonPaths[pathTo])
    }
    ...
    getKeyPath(pkfp = Err.required('getPath: pkfp'),
        ...
        return path.join(this.getHistoryDirectory(pkfp) , pkfp , this.topicKeyPaths[pathTo])
    }

    isTopicExist(pkfp){
        return fs.existsSync(path.join(this.getHistoryDirectory(pkfp) , pkfp));
    }

    isHistoryExist(pkfp){
        return fs.existsSync(path.join(this.getHistoryDirectory(pkfp) , pkfp , "history_store"));
    }

    async fixHistory(pkfp){
        let historyFixer = new HistoryFixer("this.getHistoryDirectory(pkfp)" + pkfp,  "history_store")
