...
const { iCrypto } = require("../../../common/iCrypto.js");
...
class TopicAuthorityManager{
     ...
     */
    async createTopicAuthority(clientPkfp = Err.required("clientPkfp"),
                               clientPublicKey = Err.required("clientPublicKey"),
                               clientResidence = Err.required("clientResidence"),
                               taPrivateKey = Err.required("taPrivateKey"),
                               vaultId = Err.required("vaultId")){
        ...
        await ta.initialize(clientPublicKey, clientResidence, taPrivateKey, taResidence, vaultId);
