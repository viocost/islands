...
class TorConnector extends EventEmitter{
    ...
    initServer(){
        ...
        httpServer.listen(this.httpPORT, this.httpHOST, ()=>{
            console.log('Hidden service server listening on ' + this.getConnectionString());
        });
    ...
    async createHiddenService(privateKey){
        ...
        console.log(`Tor connector create hidden service: ${this.httpPORT}`);
    ...
    getWSOnionConnectionString(onion, wss = false){
        ...
        let onionPattern = /[a-z0-9]{16}\.onion/;
