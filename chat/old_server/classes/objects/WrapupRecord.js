/**
 * TODO Desc here
 * Wrapup record is a fixed length set of following pointers:
 *
 * 0-16 last metadata start
 * 16-32 last metadata end
 * 32-48 last message start
 * 48-64 last message end
 *
 * It is appended after each blob in history file
 *
 */
class WrapupRecord{
