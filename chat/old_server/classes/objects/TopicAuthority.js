...
class TopicAuthority extends EventEmitter{
    ...
    async processDelInviteRequest(request){
        ...
        await this.hm.taDelInvite(invite.getInviteCode(), this.pkfp);
    ...
    async initialize(clientPublicKey, clientResidence, taPrivateKey, taResidence, vaultId) {
        ...
        //persisting
        await this.hm.initTopicAuthority(this.getPkfp(), vaultId);
