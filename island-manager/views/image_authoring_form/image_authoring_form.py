...
class Ui_ImageAuthoringForm(object):
    def setupUi(self, ImageAuthoringForm):
        ...
        ImageAuthoringForm.resize(1024, 623)
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(ImageAuthoringForm)
        ...
        self.verticalLayout_11.addWidget(self.form_title)
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setSpacing(41)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setSpacing(27)
        ...
        self.select_branch = QtWidgets.QComboBox(self.groupBox)
        self.select_branch.setObjectName("select_branch")
        self.horizontalLayout_7.addWidget(self.select_branch)
        self.btn_create_branch = QtWidgets.QPushButton(self.groupBox)
        self.btn_create_branch.setMaximumSize(QtCore.QSize(144, 16777215))
        self.btn_create_branch.setObjectName("btn_create_branch")
        self.horizontalLayout_7.addWidget(self.btn_create_branch)
        ...
        self.verticalLayout_11.addWidget(self.progress_wrap)
...
"}")
    ...
    def retranslateUi(self, ImageAuthoringForm):
        ...
        self.label_2.setText(_translate("ImageAuthoringForm", "Branch:"))
        self.btn_create_branch.setText(_translate("ImageAuthoringForm", "Create New Branch"))
        ...
        self.label_8.setText(_translate("ImageAuthoringForm", "Version:"))
        self.image_version.setInputMask(_translate("ImageAuthoringForm", "0009"))
        ...
        self.image_release.setInputMask(_translate("ImageAuthoringForm", "0099"))
        ...
        self.image_modification.setInputMask(_translate("ImageAuthoringForm", "0099"))
