...
** PROJ New client
*** Milestones
1. Messges loading, topic activation, metadata settings loading
2. Send/receive messages
3. Create/delete topic
4. Create/delete/rename invites
5. Members' nicknames aliases management
6. Boot member/leave
7. Files transfer
8. Mute members
9. Mute topics
10. Unread messages display
11. Reconnection
12. Light theme / dark theme
13. Vault registration, password change
