...
*** TODO Implement connection drops when topic becomes inactive
1. When no message has been sent or received in N minutes, drop all connections to other participants
Brian -- OtterFri, 9/04 18:31
2. When a message should be sent reconnect any non-connected participant (and resync) and send to all participants
Brian -- OtterFri, 9/04 18:32
3. when a connection occurs, re-connect any non-connected participants and resync
...
*** TODO get rid of simple ram queue
